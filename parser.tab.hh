  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SYSTEM = 43,                           // SYSTEM
        S_OUT = 44,                              // OUT
        S_PRINTLN = 45,                          // PRINTLN
        S_LOWER_THAN_ELSE = 46,                  // LOWER_THAN_ELSE
        S_YYACCEPT = 47,                         // $accept
        S_root = 48,                             // root
        S_Goal = 49,                             // Goal
        S_MainClass = 50,                        // MainClass
        S_MainMethod = 51,                       // MainMethod
        S_ClassDeclarations = 52,                // ClassDeclarations
        S_ClassDeclaration = 53,                 // ClassDeclaration
        S_ClassBody = 54,                        // ClassBody
        S_ClassMember = 55,                      // ClassMember
        S_VarDeclaration = 56,                   // VarDeclaration
        S_MethodDeclaration = 57,                // MethodDeclaration
        S_MethodParameters = 58,                 // MethodParameters
        S_MethodBody = 59,                       // MethodBody
        S_ReturnStatement = 60,                  // ReturnStatement
        S_Type = 61,                             // Type
        S_Statements = 62,                       // Statements
        S_Statement = 63,                        // Statement
        S_SystemOutPrintln = 64,                 // SystemOutPrintln
        S_expression = 65,                       // expression
        S_expressions = 66,                      // expressions
        S_ArgumentList = 67                      // ArgumentList
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ANDOR (std::string v)
      {
        return symbol_type (token::ANDOR, std::move (v));
      }
#else
      static
      symbol_type
      make_ANDOR (const std::string& v)
      {
        return symbol_type (token::ANDOR, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SYSTEM (std::string v)
      {
        return symbol_type (token::SYSTEM, std::move (v));
      }
#else
      static
      symbol_type
      make_SYSTEM (const std::string& v)
      {
        return symbol_type (token::SYSTEM, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OUT (std::string v)
      {
